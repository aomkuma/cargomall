angular.module('app').controller('ProblemsController', function($scope, $cookies, $filter, $state, $sce, $uibModal, $templateCache, $localStorage, $log, HTTPService, IndexOverlayFactory) {
	//console.log('Hello !');
  ...
  $scope.getList = function(){
      ...
      HTTPService.clientRequest('problems/list/by-user', null).then(function(result){
  ...
  $scope.dialogUpdateData = function(data){
      ...
      var modalInstance = $uibModal.open({
          animation : false,
          templateUrl : 'views/dialog-problems-user.html',
          size : 'md',
          scope : $scope,
          backdrop : 'static',
  ...
  $scope.confitmUpdateData = function(ProblemData){
      ...
      HTTPService.clientRequest('problems/update/by-user', params).then(function(result){
        if(result.data.STATUS == 'OK'){
