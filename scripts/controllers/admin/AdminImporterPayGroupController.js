angular.module('app').controller('AdminImporterPayGroupController', function($scope, $cookies, $filter, $state, $sce, $uibModal, $templateCache, $localStorage, $log, $location, HTTPService, IndexOverlayFactory) {
    ...
    $scope.getImporterList = function(){
    	IndexOverlayFactory.overlayShow();
  		...
  		HTTPService.clientRequest('admin/importer/group', params).then(function(result){
