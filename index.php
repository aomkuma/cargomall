			...
			<div class="dialog-confirm-form">
				<div class="row form-group">
					<div class="col-md-10 col-md-offset-1 col-sm-12 col-xs-12">
						...
						คุณสามารถตรวจสอบสถานะของ order ได้ที่เมนู <a href="tracking-orders" target="_blank">"ตรวจสอบรายการสถานะสินค้า"</a> ค่ะ
					</div>
				</div>
				<div class="row form-group">
					<div class="col-md-10 col-md-offset-1 col-sm-12 col-xs-12 text-center">
						<button class="btn btn-primary" data-ng-click="closeSuccessOrderDialog()">ไปยังหน้าชำระเงิน</button>
					</div>
				</div>
			</div>
		</div>
