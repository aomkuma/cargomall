...
class Order extends Model
{
    ...
    protected $fillable = [
        'id', 'user_id', 'order_no', 'tracking_no', 'tracking_no_thai', 'import_fee', 'net_price', 'estimate_cost', 'actual_cost', 'customer_return_actual_cost', 'transport_type', 'payment_type', 'product_type', 'receive_order_type', 'customer_address_id', 'transport_company', 'transport_company_other', 'add_on', 'check_use_cash_balance', 'use_cash_balance', 'order_status', 'china_arrival_date'
